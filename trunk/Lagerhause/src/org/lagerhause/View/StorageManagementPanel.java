...
/**
 * A tárolók kezelésére alkalmas panel
 * @author Pilán Ádám György
 *
 */
public class StorageManagementPanel extends Panel implements View {
	//-------------------------------------------------------------
	...
	public StorageManagementPanel(){
		setCaption(Constants.STORAGE_MANAGEMENT_CAPTION);
		setStyleName(Constants.STYLE_MAIN_TITLE);
		setSizeFull();
		final TableCreatorUtility tcu = new TableCreatorUtility(Constants.STORAGE_MANAGEMENT_TITLE,Storage.class);
